...
description: Helps the agent create new Global Skills following the Antigravity Skill Creator System standards. Use when the user asks to create a new skill.
---
