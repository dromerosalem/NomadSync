...
export type ViewState = 'AUTH' | 'DASHBOARD' | 'CREATE' | 'TIMELINE' | 'ADD_ITEM' | 'ITEM_FORM' | 'EDIT_TRIP' | 'ITEM_DETAILS' | 'MANAGE_TEAM' | 'INVITE_MEMBER' | 'PROFILE' | 'BUDGET' | 'LOG_EXPENSE' | 'LEDGER' | 'JOIN_MISSION' | 'GLOBAL_LEDGER' | 'PRIVACY' | 'TERMS' | 'ONBOARDING' | 'VERIFIED';
