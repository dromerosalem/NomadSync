...
const ItemCard: React.FC<{ item: ItineraryItem, tripYear: number, isLast: boolean, onClick: () => void }> = ({ item, tripYear, isLast, onClick }) => {
  const getIcon = () => {
    switch(item.type) {
               ...
               <div className="p-5 pt-3">
                    <div className="flex justify-between items-start mb-1">
                       ...
                       <div className="text-right">
                           ...
                           {item.cost ? <div className="text-xs text-gray-500 font-mono mt-1">-${item.cost}</div> : null}
                       </div>
                    </div>
             ...
             <div className="space-y-1">
                 <div className="flex justify-between text-[10px] font-bold uppercase tracking-widest">
                    ...
                    <span className={remainingBudget < 0 ? "text-red-500" : "text-tactical-accent"}>
                        ${myTotalCost.toFixed(0)} / ${userBudget}
                    </span>
                 </div>
             ...
             {availableTags.length > 0 && (
                <div className="flex gap-2 overflow-x-auto pb-1 mt-4 scrollbar-hide -mx-6 px-6">
                    <button 
                        ...
                        className={`text-[10px] font-bold px-3 py-1.5 rounded border transition-colors whitespace-nowrap uppercase tracking-wider ${
                            activeFilter === null 
