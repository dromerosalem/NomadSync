        ...
        <div className="flex flex-col min-h-full bg-tactical-bg p-6 animate-fade-in">
            ...
            <div className="mt-8 mb-12 text-center">
                <div className="relative w-16 h-16 mx-auto mb-6">
                    <div className="relative w-full h-full bg-tactical-accent/10 rounded-full flex items-center justify-center border border-tactical-accent/30 box-glow">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-4 mb-12 relative overflow-hidden group">
                ...
                <div className="flex items-center gap-3 mb-4">
                    <div className="w-8 h-8 rounded bg-tactical-accent/20 flex items-center justify-center">
                ...
                <div className="space-y-3 font-mono text-xs">
                    <div className="flex justify-between items-center bg-tactical-accent/5 p-2 rounded border border-tactical-accent/20">
                        <span className="text-white/60">Amount:</span>
                        <span className="text-tactical-accent font-bold">$42.50</span>
                        <div className="w-4 h-4 border border-tactical-accent rounded flex items-center justify-center">
                            <div className="w-2 h-2 bg-tactical-accent rounded-sm"></div>
                        </div>
                    </div>
                    <div className="flex justify-between items-center bg-tactical-accent/5 p-2 rounded border border-tactical-accent/20">
                        <span className="text-white/60">Date:</span>
                        <span className="text-tactical-accent font-bold">2026-02-01</span>
                        <div className="w-4 h-4 border border-tactical-accent rounded flex items-center justify-center">
                            <div className="w-2 h-2 bg-tactical-accent rounded-sm"></div>
                        </div>
                    </div>
